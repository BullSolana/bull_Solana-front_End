...
export default function Tokenomics() {
    return (
        <div id="tokenomics" className="section py-8 sm:py-16 flex flex-col items-center bg-black">
            ...
            <div className="px-10 py-4 sm:py-16 grid grid-cols-1 sm:grid-cols-2 items-center justify-center">
                <div className="flex flex-col space-y-6 pr-0 sm:pr-10">
                ...
                <div className='mt-4 sm:mt-0 w-full flex flex-col items-end'>
